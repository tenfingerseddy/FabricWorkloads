...
tags:
  ...
  - KQL
  - Fabric REST API
meta_description: "A technical deep-dive into three strategies for correlating execution events across Fabric item types — activity-run matching, rootActivityId propagation, and time-window overlap — with real code, real API calls, and real KQL queries."
author: "Observability Workbench Team"
---

# Cross-Item Correlation in Microsoft Fabric: How We Link Pipelines, Notebooks, and Refreshes Into a Single Execution Chain
...
**[github.com/tenfingerseddy/FabricWorkloads](https://github.com/tenfingerseddy/FabricWorkloads)**
