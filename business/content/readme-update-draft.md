...
> This file contains a proposed update to the main repo README at
> https://github.com/tenfingerseddy/FabricWorkloads
>
> Review this draft, then apply the changes to the actual README.md.
> Do not push directly -- create a branch and PR for review.

---

## Changes Summary

1. Added "Live Data" badge showing 110+ events tracked
2. Added "SLOs Tracked" badge showing 36 snapshots
3. Elevated CU Waste Score to a prominent feature with its own section
4. Added a "Live Results" section with real numbers from production
5. Added pricing link and free tier mention
6. Added "Resources" section linking to blog posts
7. Minor restructuring to make the value proposition clearer at first glance
...
Plus: Fabric notebooks for in-platform execution, a standalone health check tool, and a landing page.
...
The open-source CLI and KQL queries are free forever. Paid tiers add managed infrastructure, extended retention, and enterprise features.
...
### Header Section
- Added "CU waste scoring" to the subtitle
- Added three new badges: "Events Tracked: 110+", "SLOs Tracked: 36", "Free Tier: Available"

### The Problem Section
- Added "No cost visibility" bullet point about compute waste
- Added "no unified view" clarification to the fragmented tools bullet

### New: Live Results Section
- Table showing real numbers from production: 110+ events, 36 SLOs, 7 correlations, 27 alerts, 3 notebooks

### The Solution Table
- Added CU Waste Score as a separate row with its own source file reference
- Updated CLI Tool description to include "score CU waste"

### New: CU Waste Score Section
- Dedicated section explaining the three waste dimensions
- Table format for clarity
- Reference to the KQL query file and F64 pricing basis

### What It Does Section
- Reordered to put CU waste scoring at step 5 (before ingestion) for prominence
- Added "90-day hot, 365-day cold" detail to ingestion step
- Added "likely breaches" to alerts step

### New: Pricing Section
- Three-tier pricing table (Free, Professional, Enterprise)
- Clarification that open-source components are free forever

### New: Resources Section
- Links to published blog posts
- Direct link to the CU Waste Score KQL query file

### Minor Changes
- Arrow formatting standardized (-> instead of mixed)
- Consistent em-dash usage (-- instead of mixed)
